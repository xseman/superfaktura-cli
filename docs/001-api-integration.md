...
too, which is undocumented and load-bearing for the overview. See
[API-DISCREPANCIES.md §B1](../API-DISCREPANCIES.md).
...
Read [API-DISCREPANCIES.md](../API-DISCREPANCIES.md). It catalogues every place
the docs and the live API disagree, and every place this CLI guessed wrong —
with the evidence, the code that absorbs it and the test that pins it. Add to it
